...
<div class="jumbotron jumbotron-white">
    <div class="container div-black div-border">
        <div class="col-md-3 text-center">
            <p class="lead"><img src="{{ "/images/azure-logo.png" | relative_url }}" height="100"><br><b>Azure Virtual Desktop</b></p>
        </div>
        ...
        <div class="col-md-4 text-center">
            <div class="lead"><img src="{{ "/images/company_logo.png" | relative_url }}"><br><b>Managed Cloud Hosted Desktop & Apps</b></div>
        </div>
    </div>
</div>
