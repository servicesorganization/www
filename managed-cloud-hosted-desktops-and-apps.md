...
<div class="jumbotron jumbotron-white">
    <div class="container">
        <div class="col-md-8 div-black">
            <i class="bi-list-check" style="font-size: 2rem; color: #4472C4;"></i><h7>Proof & Statistics</h7>
            <p class="lead">
                <ul>
            ...
            <i class="bi-wrench-adjustable-circle-fill" style="font-size: 2rem; color: #4472C4;"></i><h7>Proof & Statistics of Joint Solution</h7>
            <p class="lead">
                <ul>
            ...
            <i class="bi-grid-3x3-gap-fill" style="font-size: 2rem; color: #4472C4;"></i><h7>Proof & Statistics of Managed solution</h7>
            <p class="lead">
                <ul>
...
<div class="jumbotron">
    <div class="container">
        ...
        <div class="col-md-4">
            <p class="lead"><i class="fa fa-plus" aria-hidden="true"></i> <b>Business Enablement</b></p>
        </div>
        <div class="col-md-4">
