...
permalink: managed-detection-and-response.html
---
...
<style type="text/css">
    ...
    .bgimg0 {
        background-image: linear-gradient(to left, rgba(0,0,0,0), rgba(0,0,0,1)), url('../images/managed-dectection-and-response-bg.png');
...
<div class="jumbotron jumbotron-height bgimg0">
    <div class="container">
        <h12>Managed Detection and Response</h12>
        <p></p>
        <p>Build a safer digital society</p>
    </div>
</div>
